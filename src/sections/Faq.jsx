  ...
  return (
    <section>
        <Element name= "faq" className="relative">
            ...
            <div className="">
                <h3 className="h3 max-md:h5 max-w-640 max-lg:w-md mb-7 text-p4">Curiosity didn't kill the cat, it gave it answers.</h3>
                <p className="body-1 max-lg:max-w-sm">Youve got questions, we've got answers.</p>
            </div>
