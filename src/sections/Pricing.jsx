        ...
        <div className="container">
            <div className="max-w-960 pricing-head_before relative mx-auto border-l border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16">
                <h3 className="h3 max-lg:h4 max-md:h5 z-3 relative mx-auto mb-14 max-w-lg text-center text-p4 max-md:mb-11 max-sm:max-w-sm">
                    Flexible pricing for trams of all sizes
                </h3>
            ...
            {/* Pricing section  */}
            {/* here index===1 is the middle plan or the primary plan and we are styling and adding the className via clsx accordingly */}
                ...
                {plans.map((plan, index)=>(
                    ...
                    className="pricing-plan_first pricing-plan_last pricing-plan_odd pricing-plan_even relative border-2 p-7 max-xl:min-w-80 max-lg:rounded-3xl xl:w-[calc(33.33%+2px)]">
                        ...
                        index===1 ? "pt-24" : "pt-12")}>
                            ...
                            {/* for dynamically change the amount while switcing b/w the monthly and annualy we'll use a react countup package */}
                            <div className="relative z-2 flex items-center justify-center">
                                <div 
                                className={clsx("h-num flex items-start",
                                ...
                                <div className="small-l relative top-3 ml-l uppercase">
                                    /mo
                                </div>
                            </div>
                        </div>
